...
/*   Updated: 2025/07/16 16:06:37 by ankammer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    iter(arrayInt, sizeof(arrayInt) / sizeof(arrayInt[0]), printArrayMore<int>);
    iter(arrayFloat, sizeof(arrayFloat) / sizeof(arrayFloat[0]), printArrayMore<float>);
    iter(arrayStr, sizeof(arrayStr) / sizeof(arrayStr[0]), printArrayMore<std::string>);
}